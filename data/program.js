...
const PROGRAM = [
  {
    ...
    sessions: [
      ...
      { time: "8:00 PM",  title: "Opening Message",           type: "sermon",    speaker: "" },
    ],
  },
  {
    day: "Day 2",
    ...
    sessions: [
      ...
      { time: "9:00 AM",  title: "Morning Session",           type: "sermon",    speaker: "" },
      { time: "11:00 AM", title: "Worship & Ministry",        type: "worship",   speaker: "" },
      { time: "2:00 PM",  title: "Afternoon Teaching",        type: "sermon",    speaker: "" },
  ...
  },
  {
    ...
    sessions: [
      ...
      { time: "9:00 AM",  title: "Teaching on Prayer",        type: "sermon",    speaker: "" },
  ...
  },
  {
    ...
    sessions: [
      ...
      { time: "9:00 AM",  title: "Revival Message",           type: "sermon",    speaker: "" },
      { time: "11:00 AM", title: "Worship & Encounter",       type: "worship",   speaker: "" },
      { time: "2:00 PM",  title: "Breakout Sessions",         type: "workshop",  speaker: "" },
      { time: "7:00 PM",  title: "Special Revival Service",   type: "sermon",    speaker: "" },
    ],
  },
  {
    day: "Day 5",
    ...
    sessions: [
      ...
      { time: "9:00 AM",  title: "Youth Main Session",        type: "sermon",    speaker: "" },
  ...
  },
  {
    ...
    sessions: [
      ...
      { time: "9:00 AM",  title: "Closing Message",           type: "sermon",    speaker: "" },
